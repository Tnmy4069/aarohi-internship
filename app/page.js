   ...
   return (
    <div className="flex flex-col items-center p-6 bg-gray-100 min-h-screen">
      ...
      <h1 className="text-4xl font-bold text-blue-600 mb-8">
        I Started Working at AROHI Software
      </h1>
      ...
      <div className="flex flex-col md:flex-row bg-white shadow-lg rounded-lg p-6 md:p-10 w-full max-w-4xl">
        ...
        <div className="md:w-1/2 mb-6 md:mb-0 md:pr-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Hi, I'm Tanmay Hirodkar. I’m thrilled to start my journey at AROHI Software, where I’ll be leveraging my skills in software development and project management.
          </p>
